...
![Приветственный экран (RU)](screenshots/ru/01-welcome-screen.png)
![Welcome screen (EN)](screenshots/en/01-welcome-screen.png)

![Экран с вопросом (RU)](screenshots/ru/02-test-question.png)
![Test question screen (EN)](screenshots/en/02-test-question.png)

![Экран с результатами (RU)](screenshots/ru/03-result-screen.png)
![Result screen (EN)](screenshots/en/03-result-screen.png)
...
![Блок поделиться (RU)](screenshots/ru/04-share-buttons.png)
![Share buttons (EN)](screenshots/en/04-share-buttons.png)

![Форма сбора контактов (RU)](screenshots/ru/05-contact-form.png)
![Contact form (EN)](screenshots/en/05-contact-form.png)

![Страница расширенных тестов (RU)](screenshots/ru/06-full-tests-page.png)
![Full tests page (EN)](screenshots/en/06-full-tests-page.png)
